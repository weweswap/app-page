      ...
      <div>
        <div className="flex items-center gap-3 py-5">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Typography size="xs" className="text_light_gray font-bold">
              US $0.02
            </Typography>
          </div>
        </div>
        ...
        <div className="my-5 flex items-center justify-between gap-4">
          <div className="flex flex-col gap-2 ">
            <Image
              ...
              alt=""
            />
            <Typography size="sm" className="w-32 font-bold">
              100 VULT from Base
            </Typography>
          </div>
        ...
        <div className="flex flex-col gap-8 py-5">
          <div className="flex items-center gap-3">
            ...
            <Typography size="sm">Correct Network</Typography>
          </div>

          <div className="flex items-center gap-3">
            <Image src="/img/icons/success.svg" alt="" width={48} height={56} />
            <Typography size="sm">Please approve tokens</Typography>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <Typography size="xs">US $0.00 estimated fees</Typography>
            </div>
          </div>
        </div>
