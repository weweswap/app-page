        ...
        <>
          ...
          <div className="flex item-center justify-center py-5">
            ...
            <div className="w-full flex flex-col">
              ...
              {DUMMY_POOLS.map(
                ({ exchangePair, state, range, lpValue, rewards, positionId, apr
                }) => {
                  return (
                    <div onClick={() => handleShowDetails({
                      exchangePair, state, range, lpValue, rewards, positionId,
                      ...
                      <div className="pb-4  flex items-center justify-between gap-3 flex-wrap">
                        ...
                        <div className="lg:text-right flex flex-col gap-2">
                          ...
                          <Typography fs="md" ta="center" className="font-extrabold">
                            {apr}
                          </Typography>
                        </div>
                        ...
                        <div className="text-right flex flex-col gap-2">
                          ...
                          <Typography fs="md" ta="end" className="font-extrabold">
                            ${rewards}
                          </Typography>
                        </div>
                      </div>
