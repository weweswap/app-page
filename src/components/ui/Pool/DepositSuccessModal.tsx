  ...
  return (
    <Modal title="SUCCESS" onClose={props.onClose} opened={props.opened}>
        ...
        <div className="flex items-center justify-between gap-4">
            <Typography secondary size="lg">AMOUNT</Typography>
            <div className="flex flex-col items-end gap-2" >
                <Typography size="xl" fw={1000}>$34.54</Typography>
                <div className="flex items-center gap-3 text_light_gray">
                <Typography size="xs">0.0000001231231  SHARES</Typography>
                <div className="flex">
                    <Image src="/img/tokens/usdc.png" height={20} width={20} alt="" />
                    <Image src="/img/tokens/wewe.png" height={20} width={20} alt="" className="translate-x-[-5px]" />
                </div>
                </div>
            </div>
        </div>
        ...
        <Button onClick={props.onClose}>
            <Typography secondary size="lg">COMPLETED</Typography>
        </Button>
        <button className="custom_btn">
            <Typography secondary size="lg">VIEW DETAILS</Typography>
        </button>
    </Modal>
  );
};
